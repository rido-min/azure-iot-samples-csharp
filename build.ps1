...
try {
    ...
    if ($run)
    {
        ...
        RunApp iot-hub\Samples\device\DeviceReconnectionSample "IoTHub\Device\DeviceReconnectionSample" (--PrimaryConnectionString $primaryConnectionString --SecondaryConnectionString $secondaryConnectionString --TransportType $transportType)
